...
interface ToolbarProps<TValue> {
  
}

export const Toolbar = <TValue,>({}: ToolbarProps<TValue>) => {
  return (
    <section className="min-h-10 px-24 sticky left-0 shrink-0 z-[86]">
      <div className="flex items-center h-10 w-full shadow-[0_1px_0_rgb(47,47,47)]">
        ...
        <div className="flex items-center gap-px">
          ...
          <Button 
            variant="ghost" 
            size="xs" 
            className="text-[#868686] hover:text-text-[#868686] dark:hover:bg-[#262626]"
          >
            <ArrowUpDownIcon className="size-4 text-[#868686]" />
            Sort
          </Button>
          <Button.Icon className="size-7 dark:hover:bg-[#262626]">
